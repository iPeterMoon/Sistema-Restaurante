...
public class PnlBusquedaCliente extends javax.swing.JPanel {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(campoTextoNombre, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        250, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(campoTextoCorreo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                .addComponent(campoTextoTelefono,
                                                        ...
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(67, 67, 67)
                                                .addComponent(btnBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 160,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(campoTextoNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(campoTextoCorreo, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(campoTextoTelefono, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarActionPerformed
        if (!isValidCampoNombre() && !isValidCampoCorreo() && !isValidCampoTelefono()) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese un criterio de búsqueda", "Error",
        ...
        if (!isValidCampoNombre() && !isValidCampoCorreo() && isValidCampoTelefono()) {
            ...
            List<ClienteDTO> clientes = buscarClientesPorTelefono(telefono);
        ...
        if (isValidCampoNombre() && !isValidCampoCorreo() && !isValidCampoTelefono()) {
            ...
            List<ClienteDTO> clientes = buscarClientesPorNombre(nombre);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
        if (!isValidCampoNombre() && isValidCampoCorreo() && !isValidCampoTelefono()) {
            ...
            List<ClienteDTO> clientes = buscarClientesPorCorreo(correo);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
        if (isValidCampoNombre() && isValidCampoCorreo() && !isValidCampoTelefono()) {
            String nombre = campoTextoNombre.getText().trim();
            String correo = campoTextoCorreo.getText().trim();
            List<ClienteDTO> clientes = buscarClientesPorNombreYCorreo(nombre, correo);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
        if (!isValidCampoNombre() && isValidCampoCorreo() && isValidCampoTelefono()) {
            String telefono = campoTextoTelefono.getText().trim();
            String correo = campoTextoCorreo.getText().trim();
            List<ClienteDTO> clientes = buscarClientesPorTelefonoYCorreo(telefono, correo);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
        if (isValidCampoNombre() && !isValidCampoCorreo() && isValidCampoTelefono()) {
            String nombre = campoTextoNombre.getText().trim();
            String telefono = campoTextoTelefono.getText().trim();
            List<ClienteDTO> clientes = buscarClientesPorNombreYTelefono(nombre, telefono);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
        if (isValidCampoNombre() && isValidCampoCorreo() && isValidCampoTelefono()) {
            ...
            String telefono = campoTextoTelefono.getText().trim();
            String correo = campoTextoCorreo.getText().trim();
            List<ClienteDTO> clientes = buscarClientesPorNombreTelefonoYCorreo(nombre, telefono, correo);
            if (clientes != null && !clientes.isEmpty()) {
                cargarPanelesClientes(clientes);
            }
        }
