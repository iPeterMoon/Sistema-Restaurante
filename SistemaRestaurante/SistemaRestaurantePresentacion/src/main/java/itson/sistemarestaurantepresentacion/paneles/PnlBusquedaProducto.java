...
public class PnlBusquedaProducto extends javax.swing.JPanel {
    ...
    private void cargarCategorias() {
        ...
        for (TipoProducto categoria : categorias) {
            this.comboBoxCategoria.addItem(categoria.toString().substring(0, 1).toUpperCase()
                    + categoria.toString().substring(1).toLowerCase());
        }
    }
    ...
    private void cargarEventos() {
        ...
        comboBoxCategoria.addActionListener(e -> buscarProductos());
    }
        ...
        try {
            if ((campoTextoBuscar.getText().isBlank() || campoTextoBuscar.getText().equals("Buscar"))
                ...
                cargarTodosProductos();
                    ...
                    && comboBoxCategoria.getSelectedItem().equals("Seleccionar Categoría")) {
                IProductosBO productosBO = ObjetosNegocioFactory.crearProductosBO();
                productosEncontrados = productosBO.obtenerProductos(campoTextoBuscar.getText());
            } else if (!campoTextoBuscar.getText().isBlank() && !campoTextoBuscar.getText().equals("Buscar")
                    && !comboBoxCategoria.getSelectedItem().equals("Seleccionar Categoría")) {
                IProductosBO productosBO = ObjetosNegocioFactory.crearProductosBO();
                productosEncontrados = productosBO.obtenerProductos(campoTextoBuscar.getText(),
                ...
                IProductosBO productosBO = ObjetosNegocioFactory.crearProductosBO();
                productosEncontrados = productosBO.obtenerProductos(comboBoxCategoria.getSelectedItem().toString());
            }
        } catch (NegocioException e) {
            mostrarMensajeProductosNoEncontrados();
        }
        if (productosEncontrados != null && !productosEncontrados.isEmpty()) {
            cargarPanelesProductos(productosEncontrados);
        }
    }
