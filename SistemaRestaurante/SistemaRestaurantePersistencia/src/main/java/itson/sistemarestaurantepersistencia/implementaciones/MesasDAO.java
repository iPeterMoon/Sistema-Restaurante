...
/**
 * Clase que implementa la interfaz IMesasDAO y proporciona implementaciones
 * para los métodos de persistencia de mesas en el
 *
 * @author pc
 */
public class MesasDAO implements IMesasDAO {
    ...
    /**
     * Metodo para obtener una lista con todas las mesas de la base de datos y
     * convertirlas a DTO
     *
