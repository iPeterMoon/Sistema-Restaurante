...
/**
 * Clase que maneja las conexiones a la base de datos, dependiendo de si el modo
 * de pruebas está activado o no
 *
 * @author PC
 */
public class ManejadorConexiones {
    ...
    /**
     * Regresa un entityManager dependiendo de si el modo de pruebas está
     * activado o no
     *
